...
TEST_SUITE("SquareMat"){
    TEST_CASE("Constructor"){
        SUBCASE("n<0"){
            CHECK_THROWS_WITH(SquareMat(-1,3),"the size of the matrix must be positive");
        }
        SUBCASE("init with value"){
            CHECK_NOTHROW(SquareMat s(2,3));
            SquareMat s(3,3);
            CHECK(s[0][0]==3);CHECK(s[0][1]==3);CHECK(s[0][2]==3);
            CHECK(s[1][0]==3);CHECK(s[1][1]==3);CHECK(s[1][2]==3);
            CHECK(s[2][0]==3);CHECK(s[2][1]==3);CHECK(s[2][2]==3);
        }
        SUBCASE("Check Copy Constructor"){
            ...
            s2[0][0]=0;
            s[0][2]=2;
            CHECK(s[0][0]==3);CHECK(s[0][1]==3);CHECK(s[0][2]==2);
            CHECK(s[1][0]==3);CHECK(s[1][1]==3);CHECK(s[1][2]==3);
            CHECK(s[2][0]==3);CHECK(s[2][1]==3);CHECK(s[2][2]==3);
        }
    }
    ...
    TEST_CASE("+"){
        SUBCASE("Different size"){
            SquareMat s1(5,3);
            SquareMat s2(7,2);
            CHECK_THROWS_WITH(s1+s2,"The sizes of the two matrix should be the same");
        }
        SUBCASE("work"){
            SquareMat s1(3,5);
            s1[1][0]=1;
            ...
            s2[0][0]=7;
            SquareMat s3=s1+s2;
            CHECK(s3[0][0]==12);CHECK(s3[0][1]==8);CHECK(s3[0][2]==8);
            CHECK(s3[1][0]==4);CHECK(s3[1][1]==8);CHECK(s3[1][2]==8);
            CHECK(s3[2][0]==8);CHECK(s3[2][1]==8);CHECK(s3[2][2]==8);
        }
    }
    TEST_CASE("-"){
        SUBCASE("Different size"){
    ...
    TEST_CASE("^"){
        ...
        SUBCASE("Error"){
            SquareMat mat(2, 1);
            CHECK_THROWS_WITH(mat^-1,"the scalar must be bigger or equal to 0");
        }
    }
    TEST_CASE("n++"){
        SquareMat mat(2, 1);
